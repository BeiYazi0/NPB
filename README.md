...
$$\begin{aligned}\text{Maximize}&\quad\alpha f_n+(1-\alpha)f_p$$

$$s.t&\quad\|\mathbf{M}\|_1\leq N(1-s)\end{aligned}$$
...
$$\begin{aligned}\mathrm{Maximize}&\alpha f_{n}+(1-\alpha)f_{p}+\beta R$$

$$s.t&\|\mathbf{m}^{(l)}\|_{1}\leq N^{(l)}(1-s^{(l)})\end{aligned}$$
